...
export class Level1 extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.spritesheet("fighter", "assets/fighter.png", {
      frameWidth: 32,
      frameHeight: 48,
    });
    this.load.spritesheet("chest", "assets/chest_sprite.png", {
      frameWidth: 32,
      frameHeight: 32,
    });
    this.load.spritesheet("goldCoin", "assets/goldCoin.png", {
      frameWidth: 40,
      frameHeight: 40,
    });
    this.load.spritesheet("plent", "assets/plent_spritelist.png", {
      frameWidth: 48,
      frameHeight: 48,
    });
  }
  ...
  update() {
    ...
    this.monster.setVelocityX(directionX * 80);
    this.monster.setVelocityY(directionY * 80);
  }
}